...
const PlatformPerformanceChart = ({ 
  ...
  const timelineData = useMemo(() => {
    ...
    // Bolt Optimization: Reused existing `engagementMap` for O(1) lookups inside the labels loop.
    // This replaces a redundant posts grouping hash map (postsByPlatformDate) and a nested .reduce()
    // pass that re-calculated the exact same engagement sums, eliminating O(N) operations and array allocations.
