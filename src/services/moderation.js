...
export const moderateContent = (text, options = {}) => {
  ...
  // ⚡ Bolt Optimization: Replaced O(N) .filter().length with short-circuiting .some()
  // to prevent intermediate array allocation and improve performance on large issue lists
